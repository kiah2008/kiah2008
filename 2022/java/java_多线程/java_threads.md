...
从 java 源代码到最终实际执行的指令序列，会分别经历下面三种重排序：
 ...
 ![img](java_threads.assets/java-jmm-3.png) 
...
在一个线程内，在程序前面的操作先行发生于后面的操作。
 ...
 ![image](java_threads.assets/single-thread-rule-1647357747960.png) 
...
一个 unlock 操作先行发生于后面对同一个锁的 lock 操作。
 ...
 ![image](java_threads.assets/monitor-lock-rule.png) 
...
对一个 volatile 变量的写操作先行发生于后面对这个变量的读操作。
 ...
 ![image](java_threads.assets/volatile-variable-rule.png) 
...
Thread 对象的 start() 方法调用先行发生于此线程的每一个动作。
 ...
 ![image](java_threads.assets/thread-start-rule.png) 
...
Thread 对象的结束先行发生于 join() 方法返回。
 ...
 ![image](java_threads.assets/thread-join-rule.png) 
...
![image](C:/_images/pics/3646544a-cb57-451d-9e03-d3c4f5e4434a.png)
